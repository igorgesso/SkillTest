  ...
  examRow(exam){
    ...
    html += `<td>
      <div class="float-right">
        ...
        <a class="btn btn-sm btn-danger delete" data-confirm="Are you sure?" data-remote=true rel="nofollow" data-method="delete" href="/patients/${exam.patientId}/exams/${exam.id}">Destroy</a>
      </div>
    </td>`
    return html += `</tr>`
  }
